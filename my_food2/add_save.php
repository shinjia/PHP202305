...
// 寫出 SQL 語法
$sqlstr = "INSERT INTO food(foodcode, foodname, place, visited, rate, picture, intro, kind, price, star, remark) VALUES ('$foodcode', '$foodname', '$place', '$visited', '$rate', '$picture', '$intro', '$kind', '$price', '$star', '$remark') ";
// echo $sqlstr; exit;
